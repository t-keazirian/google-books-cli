...
- If you would like to display the Title and Description only, change the method in `searchForBooks.js` from `searchOptions.fullSearch(data)` to `searchOptions.titleDescription(data)` on line 41
